...
# own modules
from src.models import EncoderModel, KernelizedModel, PytorchModel, LocalModel, LinformerModel
...
MODEL_NAME: Literal[
    "EncoderModel", "PytorchModel", "LocalModel", "KernelizedModel", "LinformerModel"
] = "LinformerModel"
